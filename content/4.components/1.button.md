...
Icon of a button is specified with `icon` property and position is configured using `iconPos` attribute. The `icon` property accepts any value from the [WangsIcons](/components/icon) collection.
