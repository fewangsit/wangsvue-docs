  ...
  <div class="space-y-6">
    <div>
      ...
      <div class="mt-2 text-xs text-gray-600">
        Selected:
        {{ restrictedDate ? restrictedDate.toLocaleDateString() : 'None' }}
      </div>

      <div class="mt-1 text-xs text-gray-500">
        Allowed: {{ today.toLocaleDateString() }} -
        {{ maxDate.toLocaleDateString() }}
      </div>
    </div>

    <div>
      <h4 class="text-sm font-medium text-gray-700 mb-2">Weekdays Only</h4>
      ...
      <div class="mt-2 text-xs text-gray-600">
        Selected:
        {{ weekdaysOnly ? weekdaysOnly.toLocaleDateString() : 'None' }}
      </div>
    </div>

    <div>
      <h4 class="text-sm font-medium text-gray-700 mb-2">Excluded Dates</h4>
      ...
      <div class="mt-2 text-xs text-gray-600">
        Selected:
        {{
          excludedDatesSelection
            ? excludedDatesSelection.toLocaleDateString()
            : 'None'
        }}
      </div>
