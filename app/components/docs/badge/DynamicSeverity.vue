...
<template>
  <div class="flex flex-col gap-4">
    <div>
      <h3 class="mb-2 font-semibold">Status-based Dynamic Severity</h3>
    ...
    <div>
      <h3 class="mb-2 font-semibold">Priority-based Dynamic Severity</h3>
      ...
      <div class="flex flex-wrap gap-3">
        ...
        <Badge label="Menunggu Approval" />
      </div>
    </div>

    <p class="text-sm text-gray-600">
      getSeverity function is a project level configuration function to
      determines a sets of predefined badge label with its severity.
    </p>
  </div>
</template>
